...
var defaultTopics = [
  ...
  },
  {
    name: 'Atl-Kratos',
    popularity: 97,
    words: ['Atlassian', 'Charlie', 'Cameron', 'Daniel', 'Ella', 'Henry', 'Mahsa', 'Marcio', 'Mehri', 'Poppy', 'Ryan', 'Huy', 'Jake', 'DT', 'Janice', 'Stephen', 'Amanda', 'Thad', 'Wojtek', 'Nathan', 'Fernando', 'Mike', 'Scott', 'DynamoDB', 'Elasticsearch', 'Opensearch', 'RDS Instance', 'PostgreSQL', 'Aurora', 'S3 Bucket', 'EC2 Instance', 'IAM Role', 'Lambda', 'Cloudformation', 'Cloudwatch', 'Cloudtrail', 'Glue ETL', 'Kinesis Firehose', 'Amazon Web Services', 'Kotlin', 'Java', 'Python', 'Spring Boot', 'Micros', 'Micros Data', 'Kaleidoscope', 'Shipit', 'Sydney', 'Melbourne', 'New Zealand', 'Brisbane', 'five alarm fire', 'incident', 'PIR Action', 'Docker', 'Zoom', 'Jira', 'Confluence', 'Hello', 'Trello', 'Loom acquisition', 'Opsgenie', 'oncall', 'disturbed', 'alert', 'alarm', 'Fleet Manager', 'Viceroy', 'Emperor', 'Empire', 'Monarch', 'Freediver', 'Admiral', 'Looper', 'unit test', 'integration test', 'acceptance test', 'build', 'deployment', 'cloudtoken', 'Bamboo', 'Bitbucket', 'Stash', 'SignalFx', 'innovation week', 'recharge day', 'planning', 'retro', 'town hall', 'kudos', 'karma', 'backup', 'noisy keyboard', 'Microscope', 'office', 'Slack', 'Kanban', 'work from home', 'blog post', 'replica', 'global table', 'global secondary index', 'encryption at rest', 'restore', 'dumpling', 'Fatlassian', 'logs', 'metrics', 'grad', 'intern', 'engineer', 'senior engineer', 'team lead', 'manager', 'architect', 'remote', 'team anywhere', 'dumpster fire', 'feature flag', 'failover', 'Red Team', 'Kratos', 'Hades', 'interview', 'stand up', 'feedback', 'goals', 'bicycle', 'reorg', 'muted', 'developer productivity', 'developer joy', 'migration', 'rollout', 'yubikey', 'standing desk', 'intentional togetherness gathering', 'exception', 'planning', 'archery', 'axe throwing', 'stack ranking', 'pull request count', 'krermes', 'rust', 'team insights pulse survey', 'team lunch', 'docker', 'ice cream fridge', 'sparkling water', 'feedback is a gift', 'trello ads', 'flattening', 'onsite', 'this is fine', 'laptop', 'covid', 'empire decomposition', 'stuck in lift', 'vegetarian lunch', 'one on one', 'board game arena', 'email filter', 'don\'t fuck the customer', 'open company, no bullshit', 'build with heart and balance', 'play, as a team', 'be the change you seek', 'health insurance', 'security awareness training', 'tech stack']
  },
  {
    name: 'Atl-Kratos curated',
    popularity: 96,
    words: ['Atlassian', 'Amazon Web Services', 'Kotlin', 'Java', 'Python', 'Sydney', 'Melbourne', 'New Zealand', 'Brisbane', 'five alarm fire', 'Loom acquisition', 'on call', 'disturbed', 'alarm', 'unit test', 'retro', 'town hall', 'kudos', 'karma', 'noisy keyboard', 'office', 'Slack', 'work from home', 'dumpling', 'logs', 'metrics', 'intern', 'senior engineer', 'manager', 'remote', 'dumpster fire', 'feature flag', 'Kratos', 'Hades', 'stand up', 'goals', 'bicycle', 'reorg', 'muted', 'developer productivity', 'developer joy', 'standing desk', 'intentional togetherness gathering', 'archery', 'axe throwing', 'stack ranking', 'pull request count', 'krermes', 'rust', 'team insights pulse survey', 'team lunch', 'ice cream fridge', 'sparking water', 'feedback is a gift', 'trello ads', 'flattening', 'onsite', 'this is fine', 'laptop', 'covid', 'empire decomposition', 'stuck in lift', 'vegetarian lunch', 'board game arena', 'email filter', 'don\'t fuck the customer', 'open company, no bullshit', 'build with heart and balance', 'play, as a team', 'be the change you seek', 'health insurance', 'security awareness training', 'tech stack']
  }
];
