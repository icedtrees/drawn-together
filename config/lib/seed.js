...
var defaultTopics = [
  ...
  {
    name: 'Figma (easy)',
    words: ['Dylan', 'Evan', 'Adobe XD', 'Figma', 'Invision', 'Sketch', 'Donut', 'Lattice', 'Kris', 'Amanda', 'Praveer', 'Marie', 'Sapling', 'Expensify', 'Multiplayer', 'frame', 'comment', 'plugin', 'font']
  },
  {
    name: 'Figma (medium)',
    words: ['component', 'symbol', 'group', 'layer', 'Show and Tell', 'Cafe Figma', 'Variety Show', 'Maker Week', 'Pepper', 'Organizations', 'Staging', 'Prototype', 'Developer Handoff', 'style', 'PDF Export', 'Version History', 'Observation Mode', 'Starter Team', 'Team Library', 'Design System', 'Design System Analytics', 'Activity Logs']
  },
  {
    name: 'Figma (hard)',
    words: ['Be Bold', 'Foster Inclusivity', 'Have Fun', 'Component States', 'Editor Platform', 'Kleiner Perkins', 'Greylock', 'Sequoia', 'Auto Layout', 'Smart Animate', 'SAML', 'Domain Capture']
  }
];
